...
@section('content')
    {{-- Start Modal --}}
    @include('admin.roles.partials.modals')
    {{-- End Modal --}}
    <div>
        <div class="user_header">
            <button class="btn btn-success" id="addRole"><i class="fas fa-user-plus"></i></button>
        </div>
...
@section('scripts')
    ...
    <script src="//cdn.datatables.net/buttons/1.7.1/js/buttons.bootstrap4.js"></script>
